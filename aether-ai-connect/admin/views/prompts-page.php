...
<div class="aether-admin-wrapper full-dark fade-in">
    ...
    <div class="aether-header large">
        ...
        <h1 class="aether-title">Aktionen & Prompts verwalten</h1>
        <p class="aether-subtitle">Erstelle, optimiere und verwalte deine individuellen KI-Aktionen effizient.</p>
    </div>

    <div class="aether-card aether-create-form">
        <h2>➕ Neuen Prompt erstellen</h2>

        <div class="aether-info">
        ...
        <form id="add-prompt-form">
            <div class="aether-field">
                <label class="aether-label">Name der Aktion</label>
                <input type="text" id="new_prompt_name" class="aether-input" placeholder="z.B. Zusammenfassen" required>
            </div>

            <div class="aether-field">
                <label class="aether-label">Prompt Vorlage</label>
                <textarea id="new_prompt_text" rows="4" class="aether-input" placeholder="z.B. Kürze folgenden Text: {{text}}" required></textarea>
        ...
        <h3 class="aether-section-title" style="margin-top:30px;">🌟 Beispielaktionen</h3>
    ...
    <div class="aether-grid" style="margin-top: 40px;">
        <?php if (!empty($custom_prompts)): ?>
            <?php foreach ($custom_prompts as $index => $prompt): ?>
                <div class="aether-card aether-prompt-card">
                    <h3><?php echo esc_html($prompt['name']); ?></h3>

                    <textarea id="prompt-text-<?php echo esc_attr($index); ?>" rows="5" class="aether-input" style="margin-top:10px;"><?php echo esc_textarea($prompt['prompt']); ?></textarea>

                    <div class="aether-actions" style="margin-top: 15px;">
