...
<div class="wp-admin-wrapper full-dark fade-in">
    ...
    <img src="<?php echo plugins_url('../assets/img/wp-logo.svg', __FILE__); ?>" alt="WordPress AI Connect Logo" class="wp-logo">
        <h1 class="wp-title">API & Lizenzverwaltung</h1>
        <p class="wp-subtitle">Stelle deine Verbindung zu KI-Anbietern her und verwalte deinen Lizenzschlüssel. Sicher. Schnell. Einfach.</p>
    </div>
    ...
    <div class="wp-card">
        <form method="post" action="options.php">
            ...
            <div class="wp-section">
                <h2 class="wp-section-title">⚡ KI-Anbieter auswählen</h2>
                <p class="wp-description">Wähle deinen bevorzugten KI-Anbieter für die Textoptimierung.</p>
                <select name="ki_api_provider" id="ki_api_provider" class="wp-select">
            ...
            <div class="wp-section">
                <h2 class="wp-section-title">🔑 API-Schlüssel eingeben</h2>
                <p class="wp-description">Dein API-Key wird sicher gespeichert und für die Kommunikation mit dem KI-Anbieter genutzt.</p>
                <input type="password"
            ...
            <div class="wp-section">
                <h2 class="wp-section-title">⏳ Timeout-Einstellung</h2>
                <p class="wp-description">Lege fest, wie lange das Plugin auf eine Antwort des KI-Servers warten soll, bevor ein Fehler ausgegeben wird.</p>

                <select name="ki_api_timeout" class="wp-select">
                    <?php
            ...
            <div class="wp-section">
                <h2 class="wp-section-title">🧠 Modell wählen</h2>
                <p class="wp-description">Wähle dein Modell – je nach Anbieter stehen verschiedene Optionen zur Verfügung.</p>
                <select name="ki_api_model_<?php echo esc_attr($active_provider); ?>" id="ki_api_model" class="wp-select">
                    <?php
                    $models = [
            ...
            <div class="wp-section">
                <h2 class="wp-section-title">🛡 Lizenzschlüssel</h2>
                <p class="wp-description">Dein Lizenzschlüssel aktiviert dein Plugin vollständig. Ohne Lizenz ist der Funktionsumfang eingeschränkt.</p>
                <input type="password"
                       name="ki_license_key"
                       id="ki_license_key"
