...
/**
 * Einstellungen & Prompt-Management für WordPress AI Connect
 */
class KI_Settings {
    ...
    public function handle_prompt_actions() {
        ...
        if (isset($_POST['ki_add_prompt']) && check_admin_referer('ki_manage_prompts')) {
            ...
            wp_redirect(add_query_arg('ki_notice', 'prompt_added', admin_url('admin.php?page=wp-ai-connect')));
            exit;
        }
        ...
        if (isset($_POST['ki_delete_prompt']) && check_admin_referer('ki_manage_prompts')) {
            ...
            if (isset($prompts[$index])) {
                ...
                wp_redirect(add_query_arg('ki_notice', 'prompt_deleted', admin_url('admin.php?page=wp-ai-connect')));
                exit;
            }
        }
    }
    ...
    public function show_admin_notices() {
        ...
        $notices = [
            'prompt_added'   => __('✅ Neuer Prompt erfolgreich gespeichert.', 'wp-ai-connect'),
            'prompt_deleted' => __('🗑️ Prompt erfolgreich gelöscht.', 'wp-ai-connect'),
            'settings_saved' => __('✅ Einstellungen gespeichert.', 'wp-ai-connect')
        ];
    ...
    public function render_tab_api() {
        ...
        <form method="post" action="options.php" id="ki-settings-form">
            ...
            <table class="form-table">
                <tr>
                    <th><label for="ki_api_provider"><?php esc_html_e('Aktiver KI-Anbieter', 'wp-ai-connect'); ?></label></th>
                    <td>
