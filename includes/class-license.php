<?php
/**
 * Lizenzprüfung für WordPress AI Connect
 */
    ...
    public function check_license() {
        ...
        if (!$this->is_valid($license)) {
            ...
            add_action('admin_notices', function () {
                echo '<div class="notice notice-error"><p><strong>⚠️ WordPress AI Connect:</strong> Bitte trage einen gültigen Lizenzschlüssel unter <em>Einstellungen → WordPress AI Connect</em> ein, um das Plugin zu nutzen.</p></div>';
            });
